...
if not ROS and __name__ == "__main__":
    ...
    while True:
        ...
        smart_action = team01Goalkeeper.get_action(Goal.ScoreGoal)
        print(smart_action)
        #game_master.update_robot_actions(0, [team01Goalkeeper.get_action(Goal.ScoreGoal), (0, 0), (0, 0), (0, 0), (0, 0)])
        game_master.update_robot_actions(0, [smart_action, (0, 0), (0, 0), (0, 0), (0, 0)])
